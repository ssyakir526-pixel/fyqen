...
application layers, `AppCompositionRoot`, and the active
`InMemoryPortfolioRepository` remain Firebase-independent. Initialization does
not store Portfolio data. Cloud Firestore, Firebase Authentication, user
ownership, cloud synchronization, and Firebase UI integration are not
implemented.
